...
public enum FilterConsts implements HelpSliderConsts {
  ADD("Ajouter Filtre", "This adds a filter to the data.  Unless you save it, it will be temporary.<br>" +
  ...
  SAVE("Enregistrer", "This will save a filter for future use.  You must have at least one filter in order to save.<br>" +
  ...
  EXPORT("Exporter", "This allows you to view your data in either Microsoft Excel, or in a Google Map.<br>" +
      ...
      "   d.  Press \"Export\"."),
  PUBLISH("Publier", "This allows you to view your data in a Google Fusion Table or a Google Spreadsheet.<br>" +
