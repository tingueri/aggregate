...
public class MultimodeLoginPageServlet extends ServletUtilBase {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws
    ...
    out.print("<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">"
        ...
        + "<title>Se connecter à Peogo Survey</title>"
        ...
        + "\n-->"
        + "</script>"
        + "<input class=\"gwt-Button\" type=\"submit\" value=\"Connectez-vous avec mot de passe de Peogo Survey\"/>"
        + "</form></td>"
        + "<td valign=\"top\">Cliquez sur ce bouton pour vous connecter à Peogo Survey en utilisant le nom d'utilisateur. "
        + "et mot de passe qui vous ont été attribués par l'administrateur de Peogo Survey.</td></tr>"
        + "<tr><td valign=\"top\">"
        + "<script type=\"text/javascript\">"
        + "<!--\n"
        + "document.write('<form action=\"" + redirectParamString + "' + window.location.hash + '\" method=\"get\">');"
        + "document.write('<input class=\"gwt-Button\" type=\"submit\" value=\"Accès anonyme\"/></form>');"
        + "\n-->"
        + "</script>"
        + "</td>"
        + "<td valign=\"top\">Cliquez sur ce bouton pour accéder à Peogo Survey sans vous connecter.</td></tr>"
        + "</table>" + "</body>" + "</html>");
  }
