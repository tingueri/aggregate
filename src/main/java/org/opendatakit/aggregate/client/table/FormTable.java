...
public class FormTable extends FlexTable {
  ...
  private static String TITLE_HEADING = "Titre";
  private static int FORM_ID_COLUMN = 1;
  private static String FORM_ID_HEADING = "ID de formulaire";
  private static int MEDIA_COUNT_COLUMN = 2;
  private static String MEDIA_COUNT_HEADING = "Fichiers multimédia";
  private static int USER_COLUMN = 3;
  private static String USER_HEADING = "Utilisateur";
  private static int DOWNLOADABLE_COLUMN = 4;
  private static String DOWNLOADABLE_HEADING = "Téléchargeable";
  private static int ACCEPT_SUBMISSIONS_COLUMN = 5;
  private static String ACCEPT_SUBMISSIONS_HEADING = "Accepter les soumissions";
  private static int PUBLISH_COLUMN = 6;
  private static String PUBLISH_HEADING = "Publier";
  private static int EXPORT_COLUMN = 7;
  private static String EXPORT_HEADING = "Exporter";
  private static int DELETE_COLUMN = 8;
  private static String DELETE_HEADING = "Supprimer";
